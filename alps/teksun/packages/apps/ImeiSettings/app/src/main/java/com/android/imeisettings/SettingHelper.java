...
//import android.os.nvram.NvRAMUtils;
...
public class SettingHelper {
    ...
    public boolean clearNV() {
        ...
        try {
            result = NvRAMUtils.writeNV(NvRAMUtils.INDEX_SIM1_IMEI, new byte[NvRAMUtils.INDEX_SIM2_IMEI + NvRAMUtils.SIM2_IMEI_LENGTH - NvRAMUtils.INDEX_SIM1_IMEI]);
        } catch (Exception e) {
